...
const array = ['1','1642704524109','2','6238560742','ANU','Aa','Aah','Aarulle','Adipoli','Hi','KHADHER','SUIII','Bgm','Cosmic','Hello','Hy','Lubb','Poli','Ayn','Bgm','Owner','Poda','girls','bye','Myr','ban','Myre']
array.map( async (a) => {
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
       await message.client.sendMessage(message.jid, fs.readFileSync('./uploads/' + a + '.mp3'), MessageType.audio, { mimetype: Mimetype.mp4Audio, duration: Config.SAID, quoted: message.data, ptt: true})
